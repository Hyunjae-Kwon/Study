//java.time 패키지_날짜와 시간 객체 생성

package Day015.Chap11.sec16.ex01;
...
public class DateTimeCreateExample {
	public static void main(String[] args) throws InterruptedException{
		...
		LocalDateTime targetDateTime = LocalDateTime.of(2023, 3, 3, 21, 30, 0, 0);
		System.out.println("목표 날짜와 시간 : " + targetDateTime + "\n");
		
		//협정 세계시와 시간존 (TimeZone)
		ZonedDateTime utcDateTime = ZonedDateTime.now(ZoneId.of("UTC"));
		System.out.println("협정 세게시 : " + utcDateTime);
